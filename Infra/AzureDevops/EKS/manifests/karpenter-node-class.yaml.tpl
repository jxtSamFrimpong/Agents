...
spec:
  ...
  subnetSelectorTerms:
    # Select on any subnet that has the "karpenter.sh/discovery: "${clusterName}"
  ...
  securityGroupSelectorTerms:
    # Select on any security group that has both the "karpenter.sh/discovery: ${clusterName}" tag
  ...
  # Within a single term, all conditions are ANDed
  amiSelectorTerms:
    # Select on any AMI that has both the `karpenter.sh/discovery: "${clusterName}"`
...
#   instanceProfile: "${clusterName}-0123456778901234567789"
#   conditions:
